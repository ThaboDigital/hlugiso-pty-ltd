...
export const PortalProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const convertQuoteToInvoice = (quoteId: string): InvoiceDocument | null => {
    ...
    const newInvoice: InvoiceDocument = {
      ...
      status: quote.depositRequired > 0 ? 'deposit_paid' : 'unpaid',
      items: [...quote.items],
      ...
      notes: `Generated from Quote ${quote.quoteNumber}. Deposit credited: R${quote.depositRequired.toLocaleString()}. Balance due upon setup.`,
      createdAt: new Date().toISOString(),
    };
